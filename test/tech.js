var Q = require('q'),
    ...
    createTech = require(process.env.COVER? '../lib-cov/lib/tech' : '../lib/tech').createTech;
...
function testBaseTech(techPath, techAlias) {
    ...
    var bemLib = process.env.COVER? 'bem/lib-cov/lib/' : 'bem/lib/',
        ...
        re = process.env.COVER? /^\.\.\/lib-cov\/lib\// : /^\.\.\/lib\//;
...
describe('tech', function() {
    ...
    var lib = process.env.COVER? '../lib-cov/lib/' : '../lib/';
